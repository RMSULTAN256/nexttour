...
export default function DetailPaketTour() {
  ...
  // 🛠️ PERUBAHAN DI SINI: Mengubah pencarian menjadi id === 3
  const tourData = tourPackages.find((p: { id: number }) => p.id === 3) || tourPackages[0];
        ...
        <div className="w-full lg:w-[400px]">
          <div className="bg-white p-6 md:p-8 rounded-3xl shadow-2xl border border-gray-100 lg:sticky lg:top-24">
            ...
            <a 
              ...
              className="w-full bg-[#25D366] hover:bg-[#1DA851] text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-green-500/30 transition-all duration-300 flex items-center justify-center gap-2"
            >
